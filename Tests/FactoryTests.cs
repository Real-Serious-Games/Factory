...
namespace Utils.Tests
{
    public class FactoryTests
    {
        ...
        {
            public interface ISingletonTest1
            {

            }

            public interface ISingletonTest2
            {

            }

            [LazySingleton(typeof(ISingletonTest1))]
            [LazySingleton(typeof(ISingletonTest2))]
            public class SingletonTest : ISingletonTest1, ISingletonTest2
            {

            }

            public class DependsOnSingleton
            {
                [Dependency]
                public ISingletonTest1 Test1 { get; set; }

                [Dependency]
                public ISingletonTest2 Test2 { get; set; }
            }

            [Fact]
            public void singleton_dependency_is_cached_after_creation()
            {
                var mockLogger = new Mock<ILogger>();
                var testObject = new Factory("test", mockLogger.Object);

                testObject.Type<ISingletonTest1>(typeof(SingletonTest));

                var created = testObject.ResolveDep<ISingletonTest1>();

                var cached1 = testObject.RetreiveDependency<ISingletonTest1>();
                Assert.Equal(created, cached1);

                var cached2 = testObject.RetreiveDependency<SingletonTest>();
                Assert.Equal(created, cached2);
            }

            [Fact]
            public void singleton_dependency_can_be_satisfied_through_shared_object_type()
            {
                var mockLogger = new Mock<ILogger>();
                var testObject = new Factory("test", mockLogger.Object);

                testObject.Type<ISingletonTest1>(typeof(SingletonTest));
                testObject.Type<ISingletonTest2>(typeof(SingletonTest));

                var created1 = testObject.ResolveDep<ISingletonTest1>();
                var created2 = testObject.ResolveDep<ISingletonTest2>();

                Assert.Equal((SingletonTest)created1, (SingletonTest)created2);
            }

            [Fact]
            public void singleton_can_be_explicitly_resolved()
            {
                var mockLogger = new Mock<ILogger>();
                var testObject = new Factory("test", mockLogger.Object);
            ...
            [Fact]
            public void same_singleton_can_be_resolved_twice()
            {
                var mockLogger = new Mock<ILogger>();
                var testObject = new Factory("test", mockLogger.Object);
                ...
                var created1 = testObject.ResolveDep<ISingletonTest1>();
                var created2 = testObject.ResolveDep<ISingletonTest1>();
            ...
            [Fact]
            public void singleton_can_be_resolved_from_cache()
            {
                var mockLogger = new Mock<ILogger>();
                var testObject = new Factory("test", mockLogger.Object);
                ...
                var dependee = new DependsOnSingleton();
                testObject.ResolveDependencies(dependee);

                Assert.NotNull(dependee.Test1);
                Assert.NotNull(dependee.Test2);
                Assert.Equal((SingletonTest)dependee.Test1, (SingletonTest)dependee.Test2);
                Assert.Equal(dependee.Test1, testObject.ResolveDep<ISingletonTest1>());
                Assert.Equal(dependee.Test2, testObject.ResolveDep<ISingletonTest2>());
            }
        }
        ...
        public class can_order_types_based_on_dependencies_when_types_are_already_in_correct_order
        {
            ...
            public void test()
            {
                ...
                var sorted = testObject.OrderByDeps<TestFactoryCreatableAttribute>(types, a => a.TypeName).ToArray();
        ...
        public class can_order_types_based_on_property_dependencies_with_intermediate_type
        {
            ...
            public void test()
            {
                ...
                testObject.Type<ITest2>(typeof(Test2));
        ...
        public class throws_when_attempting_to_order_types_that_have_circular_dependency
        {
            ...
            public void test()
            {
                ...
                Assert.Throws<ApplicationException>(() =>
                    testObject.OrderByDeps<TestFactoryCreatableAttribute>(types, a => a.TypeName)
                );
            }
        }
    }
